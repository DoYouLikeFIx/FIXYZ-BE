...
class JacksonConfigTest {
  ...
  void serializesInstantsAsIso8601AndOmitsNullValues() throws Exception {
    SamplePayload payload = new SamplePayload("fep-simulator", null, Instant.parse("2026-03-16T01:02:03Z"));

    String json = objectMapper.writeValueAsString(payload);

    assertThat(json).contains("\"name\":\"fep-simulator\"");
  ...
  void ignoresUnknownPropertiesWhenReadingJson() throws Exception {
    ...
    assertThat(payload.name()).isEqualTo("fep-simulator");
