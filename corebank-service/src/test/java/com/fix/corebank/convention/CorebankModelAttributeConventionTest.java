...
class CorebankModelAttributeConventionTest {

  @Test
  void requestDtoParametersInControllersMustUseModelAttributeOrRequestBody() {
    ClassPathScanningCandidateComponentProvider scanner = new ClassPathScanningCandidateComponentProvider(false);
    scanner.addIncludeFilter(new AnnotationTypeFilter(RestController.class));

    Set<Class<?>> controllerClasses = scanner.findCandidateComponents("com.fix.corebank.controller").stream()
        .map(beanDefinition -> {
          try {
