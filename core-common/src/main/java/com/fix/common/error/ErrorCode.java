...
public enum ErrorCode {
  ...
  AUTH_PASSWORD_RECOVERY_CHALLENGE_INVALID("AUTH-022", "recovery challenge token is invalid or expired", 401),
  AUTH_PASSWORD_RECOVERY_CHALLENGE_BOOTSTRAP_UNAVAILABLE("AUTH-023", "recovery challenge bootstrap is currently unavailable", 503),
  AUTH_PASSWORD_RECOVERY_CHALLENGE_REPLAYED("AUTH-024", "recovery challenge token already used", 401),
  AUTH_PASSWORD_RECOVERY_CHALLENGE_VERIFY_UNAVAILABLE("AUTH-025", "recovery challenge verification is currently unavailable", 503),
